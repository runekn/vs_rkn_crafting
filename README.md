...
| `DisableInventoryGuiDialog`          | `false`  | Disable inventory dialog (E) completely. This is only intended as compatibility with other mods that remove inventory grid.                                                                                                                                  | Client           |
